...
// ===== LIST OF QURAN RECITERS (با سرور رسمی mp3quran.net) =====
const quranReciters = [
    {
        id: 'abdulbasit-murattal',
        name: 'عبدالباسط عبدالصمد',
        desc: 'مرتّل - سرور mp3quran',
